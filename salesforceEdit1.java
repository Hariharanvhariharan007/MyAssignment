package assiment;
		...
		public class salesforceEdit1 {
			public static void main(String[] args) throws InterruptedException {
				...
				Thread.sleep(600);
				driver.findElement(By.xpath("//input[@name='Account-search-input']")).sendKeys("HARIHARN",Keys.ENTER);
				Thread.sleep(3000);
				driver.findElement(By.xpath("//a[text()='HARIHARN']")).click();
				...
				driver.findElement(By.xpath("//input[@name='Name']")).sendKeys("KING Hari");
