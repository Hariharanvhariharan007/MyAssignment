...
public class saleId {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("//input[@name='Name']")).sendKeys("HARIHARN");
		...
		String text = driver.findElement(By.xpath("//lightning-formatted-text[text()='HARIHARN']")).getText();
		if (text.equals("HARIHARN")) {
